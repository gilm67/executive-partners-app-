...
export const jobsBySlug: Record<string, Job> = {
  ...
  // ── Active mandates (linked from jobs list) ──

  "rm-argentina-ch": {
    slug: "rm-argentina-ch",
    title: "Senior Relationship Manager — Argentine Market",
    market: "LATAM · Argentina",
    location: "Zurich or Geneva, Switzerland",
    seniority: "Director / Executive Director",
    summary: "Senior RM mandate for the Argentine HNW/UHNW market. The hiring bank is realistic about portability timelines and offers a structured transition package. Zurich or Geneva — both open.",
    overview: ["Manage and grow a portfolio of Argentine HNW and UHNW clients.", "Deliver holistic solutions across advisory, discretionary mandates, credit and wealth planning.", "Work within an established LATAM infrastructure with full booking centre access."],
    responsibilities: ["Originate net new money from Argentine families, entrepreneurs and internationally mobile clients.", "Deepen wallet share through disciplined advisory and structured solutions.", "Maintain compliance with Swiss and Argentine cross-border frameworks."],
    qualifications: ["7+ years managing Argentine private clients with demonstrable portable AUM.", "Deep understanding of Argentine offshore wealth dynamics, currency controls and capital flight structures.", "CHF 250M+ 3-year average portable book required."],
    offer: ["Structured NPC contribution and realistic transition window.", "Established LATAM desk with product depth and booking centre flexibility.", "Competitive base and performance bonus."],
    compliance: ["Full Swiss cross-border compliance required.", "Argentine FATCA/CRS reporting familiarity expected."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "greece-cyprus-geneva": {
    slug: "greece-cyprus-geneva",
    title: "Senior Relationship Manager — Greek & Cypriot Market",
    market: "Greece · Cyprus",
    location: "Geneva, Switzerland",
    seniority: "Director / Executive Director",
    summary: "Senior RM for Greek and Cypriot HNW/UHNW clients, Geneva-based. CHF 200M+ portable book required. Established platform with strong product depth.",
    overview: ["Manage a portfolio of Greek and Cypriot HNW/UHNW clients from Geneva.", "Deliver investment, structuring and credit solutions tailored to Greek and Cypriot wealth profiles.", "Partner with compliance and booking centre teams on cross-border requirements."],
    responsibilities: ["Grow portable Greek and Cypriot AUM through personal relationships.", "Provide advisory across investments, real estate structuring and succession planning.", "Maintain FINMA-grade KYC and suitability standards."],
    qualifications: ["7+ years managing Greek or Cypriot private clients.", "CHF 200M+ 3-year average portable book.", "Greek language skills a strong advantage."],
    offer: ["Geneva platform with specialist coverage.", "Competitive compensation with relocation support.", "Retention structure available."],
    compliance: ["Swiss cross-border compliance for EU-resident clients.", "CRS/FATCA reporting experience required."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "ia-cis-cee-geneva": {
    slug: "ia-cis-cee-geneva",
    title: "Investment Advisor — CIS & CEE Market (Geneva)",
    market: "CIS · CEE · Russian-speaking",
    location: "Geneva, Switzerland",
    seniority: "Senior Analyst / Associate Director",
    summary: "Pure investment advisory role covering CIS and CEE clients at a Geneva private bank. The bank provides the client base. No AUM minimum. Russian-speaking profile strongly preferred.",
    overview: ["Deliver tailored investment advice to HNW/UHNW CIS and CEE clients.", "Construct and optimise portfolios across equities, fixed income, structured products and alternatives.", "Partner with relationship managers on joint client coverage."],
    responsibilities: ["Provide disciplined portfolio construction and risk-appropriate investment recommendations.", "Conduct regular portfolio reviews and present strategies clearly to clients.", "Act as the trusted investment contact for existing clients alongside the RM team."],
    qualifications: ["5+ years in investment advisory within private banking.", "CFA, CIIA or CWMA strongly preferred.", "Russian language skills a strong differentiator — close to mandatory for this client base."],
    offer: ["Established CIS/CEE client base provided.", "Advisory performance bonus.", "Geneva-based with strong institutional support."],
    compliance: ["Swiss suitability and MiFID-equivalent standards.", "Cross-border framework for CIS/CEE clients."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "ia-cis-cee-zurich": {
    slug: "ia-cis-cee-zurich",
    title: "Investment Advisor — CIS & CEE Market (Zurich)",
    market: "CIS · CEE · Russian-speaking",
    location: "Zurich, Switzerland",
    seniority: "Senior Analyst / Associate Director",
    summary: "Parallel mandate to the Geneva Investment Advisor search — different institution, separate CIS/CEE client base, Zurich-based. Russian-speaking profile required.",
    overview: ["Deliver investment advice to Russian-speaking HNW/UHNW clients from the CIS and CEE region.", "Build trusted investment relationships over time alongside the RM team.", "Navigate derivatives and structured products with confidence."],
    responsibilities: ["Construct risk-appropriate portfolios and present strategies to clients.", "Conduct portfolio reviews and monitor performance against benchmarks.", "Support relationship managers in client acquisition and retention."],
    qualifications: ["5+ years in investment advisory within private banking.", "CFA or equivalent a strong asset.", "Russian language skills required."],
    offer: ["Established CIS/CEE book provided.", "Competitive advisory bonus.", "Parallel process with Geneva mandate possible for candidates open to both cities."],
    compliance: ["Swiss suitability standards.", "CIS cross-border framework experience preferred."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },
  ...
  "rm-italy-ch": {
    ...
    market: "Italy · Italian Market",
    location: "Zurich, Geneva or Lugano, Switzerland",
    seniority: "Director / Executive Director",
    summary: "Senior RM for the Italian offshore market based in Zurich, Geneva or Lugano. CHF 200M+ portable book required. Infrastructure in place — this is not a greenfield mandate.",
    overview: ["Manage and grow Italian HNW/UHNW relationships from a Swiss platform.", "Operate at the level of succession planning, real estate structuring and multi-generational wealth.", "Bring a personally owned Italian book to a well-resourced platform."],
    responsibilities: ["Build and develop Italian client relationships with demonstrable portability.", "Deliver holistic solutions across advisory, discretionary, structured products and credit.", "Maintain Swiss and EU cross-border compliance standards."],
    qualifications: ["Majority of career managing Italian clients from a Swiss platform.", "CHF 200M+ 3-year average portable Italian book.", "Deep understanding of Italian cross-border regulatory framework.", "Italian language fluency required."],
    offer: ["Established Italian franchise — infrastructure and booking centre in place.", "NPC buyout available.", "Lugano, Geneva or Zurich — location determined by candidate and team structure."],
    compliance: ["Swiss cross-border compliance for Italian-resident clients.", "CRS/FATCA Italian reporting framework."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-italy-milan": {
    slug: "rm-italy-milan",
    title: "Senior Relationship Manager — Italian Market (Milan)",
    market: "Italy · Italian Market",
    location: "Milan, Italy",
    seniority: "Director / Executive Director",
    summary: "Milan-based senior RM for the Italian onshore market. CHF 180M+ portable book. The hiring institution is upgrading from representative office to fully licensed advisory operation.",
    overview: ["Manage Italian HNW/UHNW clients and entrepreneurs from a Milan base.", "Operate at the level of wealth structuring, succession and multi-generational planning.", "Build a serious Italian franchise on a growing platform."],
    responsibilities: ["Grow Italian onshore AUM through personal relationships.", "Deliver investment and structuring solutions to Italian entrepreneurs and families.", "Operate within Italian regulatory and compliance framework."],
    qualifications: ["Career spent managing Italian HNW/UHNW clients.", "CHF 180M+ 3-year average portable book.", "Italian fluency mandatory.", "Milan-based — remote coverage not an option."],
    offer: ["Platform upgrading to full advisory licence — significant long-term opportunity.", "Performance bonus and business plan support.", "EUR-denominated compensation."],
    compliance: ["Italian regulatory framework.", "Consob and Bank of Italy compliance requirements."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-hong-kong": {
    slug: "rm-hong-kong",
    title: "Senior Relationship Manager — Hong Kong",
    market: "Asia Pacific · Hong Kong",
    location: "Hong Kong",
    seniority: "Director / Executive Director",
    summary: "Senior RM at a private bank with established Hong Kong presence. Greater China, Southeast Asia and international client base. Relationship quality over quantity — 15 truly owned relationships outweigh 50 institutional ones.",
    overview: ["Manage HNW/UHNW relationships across Greater China, Southeast Asia and international markets.", "Demonstrate portability based on relationship depth and tenure.", "Operate within a well-resourced Hong Kong platform."],
    responsibilities: ["Build and grow a personally owned HNW/UHNW portfolio.", "Deliver investment, credit and wealth planning solutions.", "Partner with product specialists on complex client needs."],
    qualifications: ["Senior private banking track record in Hong Kong or Greater China.", "USD/CHF 250M+ portable book.", "Hong Kong residency or firm willingness to relocate.", "Mandarin a strong advantage."],
    offer: ["Competitive relocation package.", "Established Hong Kong platform with regional reach.", "HKD-denominated compensation with bonus."],
    compliance: ["SFC licensing requirements.", "Cross-border framework for mainland and international clients."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-singapore": {
    slug: "rm-singapore",
    title: "Senior Relationship Manager — Singapore",
    market: "Asia Pacific · Singapore",
    location: "Singapore",
    seniority: "Director / Executive Director",
    summary: "Senior RM mandate in Singapore. CHF 250M+ portable book required. Southeast Asia or broader APAC market coverage.",
    overview: ["Manage UHNW/HNW clients across Southeast Asia from a Singapore platform.", "Deliver investment and wealth planning solutions within MAS-regulated environment.", "Grow AUM through personal relationships and introducer networks."],
    responsibilities: ["Originate and develop Southeast Asian or broader APAC private wealth relationships.", "Deliver holistic advisory across investments, structured products and credit.", "Maintain MAS compliance and suitability standards."],
    qualifications: ["Senior private banking experience in Singapore or Southeast Asia.", "CHF 250M+ portable book.", "MAS licensing or eligibility.", "Additional Asian language skills a plus."],
    offer: ["Senior Singapore platform with strong product access.", "SGD-denominated compensation with performance bonus.", "Competitive total package."],
    compliance: ["MAS regulatory requirements.", "Cross-border framework for regional clients."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-uk-geneva": {
    slug: "rm-uk-geneva",
    title: "Senior Relationship Manager — UK Market",
    market: "United Kingdom",
    location: "Geneva, Switzerland",
    seniority: "Director / Executive Director",
    summary: "Geneva-based mandate covering UK HNW/UHNW clients. Non-domiciled resident transition acknowledged. CHF 150M+ portable book required.",
    overview: ["Manage UK-domiciled and non-domiciled HNW/UHNW clients from Geneva.", "Cover British families, entrepreneurs, non-dom residents and internationally mobile professionals.", "Operate within Swiss cross-border framework for UK-source wealth."],
    responsibilities: ["Build and develop UK client relationships with demonstrable portability.", "Deliver investment, tax-efficient structuring and wealth planning solutions.", "Navigate post-Brexit cross-border compliance framework."],
    qualifications: ["Experience managing UK private clients from a Swiss or international platform.", "CHF 150M+ portable book — non-dom transition acknowledged in assessment.", "Strong understanding of UK regulatory and tax landscape."],
    offer: ["Geneva platform with established UK client franchise.", "NPC buyout available.", "Competitive CHF compensation."],
    compliance: ["Swiss cross-border compliance for UK-resident clients.", "Post-Brexit framework awareness required."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-south-africa-geneva": {
    slug: "rm-south-africa-geneva",
    title: "Senior Relationship Manager — South African Market (Geneva)",
    market: "Africa · South Africa",
    location: "Geneva, Switzerland",
    seniority: "Director / Executive Director",
    summary: "Geneva-based mandate for a senior banker with a genuinely owned South African client base. CHF 200M+ portable book. Relationship depth matters more than institutional brand in this market.",
    overview: ["Manage South African UHNW/HNW clients from a Geneva platform.", "Structure compliant cross-border wealth arrangements within SARB framework.", "Build on personal trust relationships rather than institutional proximity."],
    responsibilities: ["Grow South African AUM through personally owned client relationships.", "Navigate South African exchange control regulations and SARB compliance.", "Deliver sophisticated wealth management solutions from a serious Swiss platform."],
    qualifications: ["Career managing South African clients in private banking.", "CHF 200M+ portable book built on personal relationships.", "Understanding of SARB framework and South African exchange control."],
    offer: ["NPC contribution and realistic transition window.", "Established African desk with regional expertise.", "Competitive CHF compensation."],
    compliance: ["SARB and South African exchange control familiarity.", "Swiss cross-border compliance for African-source wealth."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-south-africa-london": {
    slug: "rm-south-africa-london",
    title: "Senior Relationship Manager — South African Market (London)",
    market: "Africa · South Africa",
    location: "London, United Kingdom",
    seniority: "Director / Executive Director",
    summary: "London-based mandate covering South African private wealth. Separate from Geneva role — different institution, different booking centre. Both can be explored in parallel. CHF 250M+ portable book required.",
    overview: ["Manage South African HNW/UHNW clients from a London base.", "Cover South African diaspora community and internationally mobile South African wealth.", "Operate within UK booking centre with strong structuring infrastructure."],
    responsibilities: ["Build and develop South African client relationships from London.", "Deliver wealth structuring, investment and credit solutions.", "Maintain FCA compliance and South African cross-border framework."],
    qualifications: ["Senior private banking experience with South African clients.", "CHF 250M+ portable book built on personal relationships.", "Understanding of South African offshore wealth dynamics and SARB compliance."],
    offer: ["NPC buyout available.", "London platform with strong legal and structuring infrastructure.", "GBP-denominated compensation with bonus."],
    compliance: ["FCA regulatory requirements.", "South African exchange control and SARB framework."],
    confidential: true, active: true, createdAt: "2026-05-01",
  },

  "rm-brazil-ch": {
    slug: "rm-brazil-ch",
    title: "Senior Relationship Manager — Brazilian Market",
    market: "Brazil / LATAM",
    location: "Zurich or Geneva",
    experience_min: 5,
    languages: ["Portuguese", "English"],
    summary: "Personal ownership of Brazilian HNW and UHNW family relationships with a minimum CHF 250M portable book.",
    overview: ["Executive Partners is partnering with a well-capitalised Swiss private bank to recruit a Senior Relationship Manager for the Brazilian market, based in Zurich or Geneva."],
    responsibilities: ["Manage and grow a personal book of Brazilian HNW and UHNW clients", "Drive new client acquisition within the Brazilian offshore wealth segment"],
    qualifications: ["Minimum CHF 250M portable book (3-year average)", "5+ years managing Brazilian clients within a Swiss or international private bank"],
    offer: ["Competitive base CHF 180K-280K", "Performance bonus", "NPC buyout available"],
    active: true,
    createdAt: "2026-04-15",
  },
  "rm-frontalier-geneva": {
    slug: "rm-frontalier-geneva",
    title: "Senior Relationship Manager — Franco-Genevois Cross-Border",
    market: "Switzerland / France Cross-Border",
    location: "Geneva",
    experience_min: 5,
    languages: ["French"],
    summary: "Hunter profile with a personal book of French-domiciled HNW clients and proven cross-border expertise in Geneva.",
    overview: ["Executive Partners is partnering with a well-established Geneva-based institution to recruit a Senior Relationship Manager for the Franco-Genevois cross-border market."],
    responsibilities: ["Manage and grow a personal book of French-domiciled HNW and UHNW clients", "Active new client acquisition through professional introducer networks"],
    qualifications: ["Minimum CHF 50M portable cross-border book", "Swiss residency mandatory", "Deep knowledge of Franco-Swiss fiscal conventions, IFI, and succession planning"],
    offer: ["Competitive base CHF 140K-220K", "Significant variable component", "NPC buyout available"],
    active: true,
    createdAt: "2026-05-18",
  },
  "swiss-onshore-geneva": {
    slug: "swiss-onshore-geneva",
    title: "Senior Relationship Manager — Swiss Onshore Market",
    market: "Switzerland Onshore",
    location: "Geneva",
    experience_min: 5,
    languages: ["French"],
    summary: "Swiss-resident HNW and UHNW book built through genuine advisory relationships, minimum CHF 150M portable.",
    overview: ["Executive Partners is partnering with a Swiss private bank with a genuine domestic franchise to recruit a Senior Relationship Manager for the Swiss onshore market, based in Geneva."],
    responsibilities: ["Manage and grow a portfolio of Swiss-resident HNW and UHNW clients", "Deliver wealth planning and credit structuring solutions"],
    qualifications: ["Minimum CHF 150M portable book (3-year average)", "Wealth planning and credit structuring depth", "French an advantage"],
    offer: ["Competitive base CHF 160K-240K", "Performance bonus", "Retention structure"],
    active: true,
    createdAt: "2026-05-01",
  },
  "rm-latam-new-york": {
    slug: "rm-latam-new-york",
    title: "Senior Relationship Manager — LATAM Market",
    market: "Latin America",
    location: "New York",
    experience_min: 7,
    languages: ["Spanish", "Portuguese (plus)"],
    summary: "Senior LATAM private banker for New York desk managing HNW and UHNW clients across the Latin American market.",
    overview: ["Executive Partners is partnering with a leading international private bank to recruit a Senior Relationship Manager for the LATAM market, based in New York."],
    responsibilities: ["Manage and develop a personal book of LATAM HNW and UHNW clients", "Drive new client acquisition across the Latin American market"],
    qualifications: ["Minimum CHF/USD 250M portable book", "7+ years managing LATAM clients in a private banking context"],
    offer: ["Competitive package commensurate with experience", "Performance bonus", "Relocation support available"],
    active: true,
    createdAt: "2026-04-15",
  },
