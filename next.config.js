...
{ source: "/markets", destination: "/en/markets", permanent: true },
      ...
      { source: "/recent-job-opening/", destination: "/en/jobs", permanent: true },
      { source: "/job-detail-brazil", destination: "/en/jobs", permanent: true },
      { source: "/job-detail-brazil/", destination: "/en/jobs", permanent: true },
      { source: "/job-details-poland", destination: "/en/jobs", permanent: true },
      { source: "/job-details-poland/", destination: "/en/jobs", permanent: true },
      ...
      { source: "/employers", destination: "/en/hiring-managers", permanent: true },
      { source: "/employers/", destination: "/en/hiring-managers", permanent: true }
    ];
  },
};
