  ...
  return (
    <section className="space-y-6">
      ...
      <div className="rounded-2xl border border-[#C9A14A]/30 bg-[#C9A14A]/5 p-5">
        ...
        <p className="text-sm text-white/65 mb-4">Book a 15-minute call with Executive Partners. We will walk through your score, flag what committees will challenge, and tell you which mandates fit your profile right now.</p>
