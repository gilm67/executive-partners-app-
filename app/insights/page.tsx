...
const newsletterSubscribeUrl =
  "https://www.linkedin.com/newsletters/7319810409748746241/?displayConfirmation=true"; // ✅ your link

// --- Private Wealth Pulse (newsletter issues) ---
...
const articles: Item[] = [
  ...
  {
    title:
      "Global Markets Outlook 2025: Strategic Insights for Private Bankers",
    date: "Jun 5, 2025",
  ...
  {
    title:
      "The NRI Gold Rush: Your 2025 Private Banking Playbook",
    date: "Jan 29, 2025",
  ...
  {
    title:
      "Crisis to Opportunity: Decoding the UBS-Credit Suisse Merger",
    date: "Jan 25, 2025",
  ...
  {
    title:
      "Should Private Banks Embrace Bitcoin for Their Clients?",
    date: "Jan 2, 2025",
      ...
      <div className="relative mx-auto w-full max-w-6xl px-4 pb-24 pt-10">
        <header className="mb-6 text-center">
          ...
          <p className="mx-auto mt-3 max-w-3xl text-neutral-300">
            A curated stream of our <em>Private Wealth Pulse</em> newsletter and standalone articles for private bankers and wealth leaders.
          </p>
        </header>

        {/* Subscribe panel */}
        <section className="mb-10 rounded-2xl border border-white/10 bg-white/[0.06] p-5">
          <div className="flex flex-col items-start gap-3 md:flex-row md:items-center md:justify-between">
            <div>
              <h2 className="text-lg font-semibold">Subscribe to Private Wealth Pulse</h2>
              <p className="mt-1 text-sm text-neutral-300">
                Weekly highlights on Swiss & global private banking—straight from LinkedIn.
              </p>
            </div>
            <a
        ...
        {/* Newsletter grid */}
        <Section title="Private Wealth Pulse — Recent Issues" items={newsletter.slice(0, 6)} />
      ...
      <div className="mt-5 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((item) => (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group relative block overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.03] p-5 shadow-[0_1px_3px_rgba(0,0,0,.25)] transition hover:shadow-[0_12px_50px_rgba(0,0,0,.50)]"
          >
