...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Insights — Executive Partners",
    description: "Private Wealth Pulse and articles by Executive Partners.",
...
const newsletter: Item[] = [
  ...
  {
    title: "Swiss Private Banking Weekly: Post-Crisis Resilience and Market Stabilisation",
    date: "Jul 8, 2025",
...
const articles: Item[] = [
  {
    title: "Turbulent Time: Crisis Resilience and Market Leadership in Turbulent Times (Middle East Conflict)",
    date: "Jun 22, 2025",
  ...
  {
    title: "EFG Bank Switzerland: Pioneering Private Banking with Entrepreneurial Agility and Strategic Mastery",
    date: "May 27, 2025",
  ...
  {
    title: "How to Build a Billion-Dollar Client Portfolio in International Banking: Lessons from a Top Relationship Manager",
    date: "May 14, 2025",
  ...
  {
    title: "Navigating Trump’s Economic Storm: How Private Banks and Their Clients Can Secure Assets in 2025",
    date: "Apr 13, 2025",
  ...
  {
    title: "UBS and Credit Suisse: From “Deal of the Century” to High-Stakes Turbulence",
    date: "Apr 1, 2025",
  ...
  {
    title: "The Battle of the Gulf Giants: Saudi Arabia's Vision 2030 vs. Dubai's Established Dominance",
    date: "Feb 9, 2025",
  ...
  {
    title: "Latest News on the Swiss Financial Market: A Professional Perspective for Private Bankers",
    date: "Jan 24, 2025",
  ...
  {
    title: "The Exodus of Ultra High Net Worth and High Net Worth Individuals from the UK: Reasons and Destinations",
    date: "Dec 23, 2024",
...
export default function InsightsPage() {
  return <ClientInsights newsletter={newsletter} articles={articles} />;
}
