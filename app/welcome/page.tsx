...
export default function Welcome() {
  // Auto-redirect after 2.5s (respect reduced motion)
  useEffect(() => {
  ...
  return (
    <main className="relative min-h-[100dvh] bg-[#0B0E13] text-white">
      ...
      <div className="relative z-10 flex items-center justify-center min-h-[100dvh] text-center px-6">
        <div className="animate-fade-in">
          ...
          <p className="mt-2 text-sm text-white/70">
            Zurich · Geneva · London · New York · Dubai · Hong Kong · Singapore
          </p>
          <div className="mt-10">
            <Link
              href="/"
              className="inline-block rounded-xl bg-white/10 px-6 py-3 text-white text-sm font-semibold hover:bg-white/20 transition"
            >
              Enter Website
            </Link>
          </div>
      ...
      {/* Local keyframes for the subtle entrance */}
      <style jsx>{`
        .animate-fade-in {
