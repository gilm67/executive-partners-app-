// app/en/page.tsx (server component)
...
/** Inlined CardBtn (remove external dependency) */
function CardBtn({
  href,
  tone = "neutral",
  children,
  ...
  return (
    <Link
      href={href}
      className={`inline-flex items-center justify-center rounded-xl px-3 py-2 text-sm font-semibold text-white transition ${toneCls}`}
    >
      {children}
    </Link>
  );
