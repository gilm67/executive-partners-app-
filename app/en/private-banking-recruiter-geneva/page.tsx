...
const PAGE_URL = `${SITE}/en/private-banking-recruiter-geneva`;
...
export const metadata: Metadata = {
  ...
  twitter: {
    ...
    description: "Geneva specialist for private banking recruitment. Senior RMs with CHF 75m–2bn+ AUM, Team Heads and Investment Advisors placed across UBP, Julius Baer, EFG and boutique platforms. Confidential.",
...
const orgJsonLd = {
  ...
  areaServed: ["Geneva", "Switzerland", "MEA", "LatAm", "Europe"],
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      "@type": "ListItem",
      position: 3,
      name: "Private Banking Recruiter – Geneva",
      item: PAGE_URL,
    },
  ],
};
        ...
        <div className="relative mx-auto w-full max-w-6xl px-4 pb-20 pt-12">
          ...
          <header className="max-w-3xl">
            ...
            <p className="mt-4 text-sm text-neutral-300 md:text-[0.95rem] leading-relaxed">
              Executive Partners is a Geneva-based boutique focused exclusively
              on{" "}
              ...
              specific focus on{" "}
              <span className="font-semibold text-neutral-100">
                validated AUM portability, booking-centre relevance and P&amp;L
                contribution
              </span>
              .
            </p>
          ...
          <section className="mt-12 grid gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1.2fr)]">
            <div className="space-y-4 text-sm text-neutral-200 md:text-[0.95rem] leading-relaxed">
              ...
              <p>
                Geneva remains one of Europe&apos;s most internationally
                connected wealth centres, hosting a dense network of Swiss
                private banks, foreign platforms, EAMs and family offices. The
                city combines{" "}
              ...
              <p>Over the last 24 months, hiring demand has concentrated on:</p>
              <ul className="list-disc space-y-1 pl-5 text-neutral-200">
                <li>
                  Senior RMs with{" "}
                  <span className="font-semibold">
                    proven portable UHNW/HNW books
                  </span>
                </li>
                <li>
                ...
                <li>
                  Cross-border specialists (MEA, Portugal, Spain, France,
                  Italy)
                </li>
                <li>
          ...
          <section className="mt-14 rounded-3xl border border-white/10 bg-black/40 p-6 shadow-[0_18px_50px_rgba(0,0,0,0.75)] backdrop-blur md:p-8">
            ...
            <p className="mt-3 text-sm text-neutral-300 md:text-[0.95rem]">
              ...
              booking-centre mix, product penetration and individual
              performance.
            </p>
