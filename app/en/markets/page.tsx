        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {markets.map((m) => {
            ...
            return (
              <article
                key={m.slug}
                className="group flex flex-col overflow-hidden rounded-2xl border border-white/10 bg-neutral-950/60 shadow-xl ring-1 ring-white/5 transition hover:-translate-y-1 hover:border-[#D4AF37]/70 hover:ring-[#D4AF37]/60"
              >
                {/* IMAGE */}
                ...
                <div className="flex flex-1 flex-col gap-4 p-5">
                  ...
                  <div className="mt-auto flex flex-wrap gap-2 pt-1">
                    <Link
                      ...
                      className="inline-flex flex-1 items-center justify-center gap-1 rounded-full bg-white px-4 py-2 text-xs font-medium text-black transition hover:bg-[#F4D270]"
                    >
                    ...
                    <Link
                      ...
                      className="inline-flex flex-[0.9] items-center justify-center rounded-full border border-white/30 px-4 py-2 text-xs font-medium text-white transition hover:border-[#D4AF37] hover:text-[#D4AF37]"
                    >
                      View jobs in {m.city}
                    </Link>
                  </div>
