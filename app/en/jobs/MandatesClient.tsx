...
const MANDATES = [
  ...
  { id: "arm-russian-geneva", tag: "CIS · CEE · Assistant RM", title: "Assistant Relationship Manager", subtitle: "Emerging Markets · Russian-speaking", location: "Geneva", flag: "🇷🇺", aum: "N/A", aum_note: "Supporting role — no book required", comp_base: "CHF 90K – 130K", comp_note: "base · private banking bonus structure", urgent: false,
...
const HUBS = ["All", "Geneva", "Zurich", "London", "Milan", "Hong Kong", "Singapore"];
