...
const MANDATES = [
  ...
  { id: "rm-uk-geneva", tag: "United Kingdom · UK Market", title: "Senior Relationship Manager", subtitle: "UK Market", location: "Geneva", flag: "🇬🇧", aum: "CHF 150M+", aum_note: "3-year average portable book — non-dom transition acknowledged", comp_base: "CHF 180K – 280K", comp_note: "base · bonus · NPC buyout available", urgent: false,
...
The ideal profile has spent a meaningful part of their private banking career managing UK clients from a Swiss or international platform, holds relationships in their own name, and can demonstrate genuine portability based on personal client trust rather than institutional proximity. A three-year average portable book of CHF 150M from UK clients is the minimum threshold. The bank is aware of the non-dom regime changes effective April 2025 and takes a considered view on AUM trajectory — relationship quality and portability depth are weighted alongside current book size.`,
    ...
    screening: [
      ...
      { q: "What is your current AUM under direct personal management from UK clients (not team AUM)?", options: [{ label: "Under CHF 100M", pass: false }, { label: "CHF 100M – 150M", pass: "warn" }, { label: "CHF 150M – 300M", pass: true }, { label: "Over CHF 300M", pass: true }] },
  ...
  { id: "rm-south-africa-geneva", tag: "Africa · South Africa", title: "Senior Relationship Manager", subtitle: "South African Market", location: "Geneva", flag: "🇿🇦", aum: "CHF 200M+", aum_note: "3-year average portable book", comp_base: "CHF 170K – 270K", comp_note: "base · bonus · NPC buyout available", urgent: false,
    ...
    screening: [
      ...
      { q: "What is your current AUM under direct personal management from South African clients (not team AUM)?", options: [{ label: "Under CHF 100M", pass: false }, { label: "CHF 100M – 150M", pass: "warn" }, { label: "CHF 150M – 250M", pass: true }, { label: "Over CHF 250M", pass: true }] },
  ...
  { id: "rm-south-africa-london", tag: "Africa · South Africa", title: "Senior Relationship Manager", subtitle: "South African Market", location: "London", flag: "🇿🇦", aum: "CHF 200M+", aum_note: "3-year average portable book", comp_base: "GBP 150K – 250K", comp_note: "base · bonus · NPC buyout available", urgent: false,
