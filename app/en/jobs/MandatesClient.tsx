...
const MANDATES = [
  ...
  { id: "ia-cis-cee-geneva", tag: "CIS · CEE · Russian-speaking", title: "Investment Advisor", subtitle: "CIS & CEE Market — Geneva", location: "Geneva", flag: "🇷🇺", aum: "No minimum", aum_note: "Bank provides existing client base", comp_base: "CHF 140K – 220K", comp_note: "base · advisory performance bonus", urgent: true, ubp_ref: "Job ID 542 · Union Bancaire Privée",
  ...
  { id: "arm-russian-geneva", tag: "CIS · CEE · Assistant RM", title: "Assistant Relationship Manager", subtitle: "Emerging Markets · Russian-speaking", location: "Geneva", flag: "🇷🇺", aum: "N/A", aum_note: "Supporting role — no book required", comp_base: "CHF 90K – 130K", comp_note: "base · private banking bonus structure", urgent: false, ubp_ref: "Job ID 605 · Union Bancaire Privée",
  ...
  { id: "rm-italy-milan", tag: "Italy · Italian Market", title: "Senior Relationship Manager", subtitle: "Italian Market", location: "Milan", flag: "🇮🇹", aum: "CHF 150M+", aum_note: "Relationship quality prioritised over raw volume", comp_base: "EUR 150K – 250K", comp_note: "base · performance bonus · business plan support", urgent: false,
